...
ເຄັດລັບ: ໃນເມນູບໍລິບົດທ່ານສາມາດປັບການຕັ້ງຄ່າໄດ້
        ...
        # ============================================
        # 107. ເສັ້ນທາງທີ່ໃຊ້ຫຼ້າສຸດ
        # ============================================

        'menu_recent': 'ທີ່ໃຊ້ຫຼ້າສຸດ',
        'menu_recent_dirs': 'ໄດເລກະທໍລີ...',
        'menu_recent_files': 'ໄຟລ໌...',
        'recent_manage': 'ຈັດການ...',
        'recent_enable_tracking': 'ບັນທຶກເສັ້ນທາງທີ່ໃຊ້ຫຼ້າສຸດ (ຄວາມເປັນສ່ວນຕົວ)',
        'recent_enable_info': 'ປິດຕົວເລືອກນີ້ເພື່ອບໍ່ບັນທຶກເສັ້ນທາງ',
        'recent_tracking_disabled': 'ການຕິດຕາມເສັ້ນທາງຖືກປິດ',
        'recent_enabled': 'ເປີດນຳໃຊ້',
        'recent_disabled': 'ປິດນຳໃຊ້',
        'recent_tracking_status': 'ການຕິດຕາມເສັ້ນທາງ {0}',
        'recent_dialog_title': 'ເສັ້ນທາງທີ່ໃຊ້ຫຼ້າສຸດ',
        'recent_tab_directories': 'ໄດເລກະທໍລີ',
        'recent_tab_files': 'ໄຟລ໌',
        'recent_dirs_instruction': 'ກົດສອງເທື່ອເພື່ອເປີດກ່ອງໂຕ້ຕອບໄຟລ໌ໃນໄດເລກະທໍລີ',
        'recent_files_instruction': 'ກົດສອງເທື່ອເພື່ອເປີດ PDF ໂດຍກົງ',
        'recent_no_directories': '(ບໍ່ມີໄດເລກະທໍລີທີ່ບັນທຶກໄວ້)',
        'recent_no_files': '(ບໍ່ມີໄຟລ໌ທີ່ບັນທຶກໄວ້)',
        'recent_default_current': '⭐ ຄ່າເລີ່ມຕົ້ນ: {0}',
        'recent_set_as_default': '⭐ ຕັ້ງເປັນຄ່າເລີ່ມຕົ້ນ',
        'recent_default_set_title': 'ຕັ້ງໄດເລກະທໍລີເລີ່ມຕົ້ນແລ້ວ',
        'recent_default_set_message': 'ໄດເລກະທໍລີ "{0}" ຖືກຕັ້ງເປັນຄ່າເລີ່ມຕົ້ນສຳລັບການເປີດ PDF.',
        'recent_default_set_voice': 'ຕັ້ງໄດເລກະທໍລີເລີ່ມຕົ້ນແລ້ວ',
        'recent_directory_not_found': 'ບໍ່ພົບໄດເລກະທໍລີ',
        'recent_file_not_found': 'ບໍ່ພົບໄຟລ໌',
        'recent_remove_selected': 'ລຶບ',
        'recent_remove_title': 'ລຶບເສັ້ນທາງ',
        'recent_remove_confirm': 'ທ່ານຕ້ອງການລຶບເສັ້ນທາງ "{0}" ອອກຈາກລາຍຊື່ບໍ?',
        'recent_path_removed': 'ລຶບເສັ້ນທາງແລ້ວ',
        'recent_clear_all': 'ລຶບທັງໝົດ',
        'recent_clear_title': 'ລຶບເສັ້ນທາງທັງໝົດ',
        'recent_clear_confirm_type': 'ທ່ານຕ້ອງການລົບ {0} ທັງໝົດບໍ?',
        'recent_cleared': 'ລາຍຊື່ຖືກລ້າງແລ້ວ',
        'recent_path_not_found_title': 'ບໍ່ພົບເສັ້ນທາງ',
        'recent_path_not_found_message': 'ເສັ້ນທາງ "{0}" ບໍ່ມີຢູ່ແລ້ວ.',
        'recent_open_file': 'ເປີດໄຟລ໌',
        'btn_open_recent': 'ເປີດ',
        'recent_open_file_question': 'ທ່ານຕ້ອງການເປີດ "{0}" ເປັນ PDF ບໍ?',
        'recent_not_pdf': 'ໄຟລ໌ທີ່ເລືອກບໍ່ແມ່ນ PDF.',
        'recent_more_entries': 'ລາຍການເພີ່ມເຕີມ...',
        'btn_remove': 'ລຶບ',
        'btn_clear': 'ລ້າງທັງໝົດ',
        'recent_context_open': 'ເປີດ',
        'recent_context_reveal': 'ສະແດງໃນ Finder',
        'recent_context_set_default': '⭐ ຕັ້ງເປັນຄ່າເລີ່ມຕົ້ນ',
        'recent_context_open_terminal': '💻 ເປີດ Terminal',
        'recent_context_file_info': 'ຂໍ້ມູນໄຟລ໌',
        'recent_context_open_with_default': '📄 ເປີດດ້ວຍແອັບເລີ່ມຕົ້ນ',
        'recent_context_remove': 'ລຶບອອກຈາກລາຍຊື່',
        'recent_context_clear_all': 'ລຶບທັງໝົດ',
        'recent_file_info_title': 'ຂໍ້ມູນໄຟລ໌',
        'recent_file_info_name': 'ຊື່',
        'recent_file_info_path': 'ເສັ້ນທາງ',
        'recent_file_info_size': 'ຂະໜາດ',
        'recent_file_info_modified': 'ດັດແກ້ຫຼ້າສຸດ',
        'recent_file_info_pages': 'ໜ້າ',
        'recent_error_reveal': 'ຂໍ້ຜິດພາດໃນການເປີດໃນ Finder',
        'recent_error_terminal': 'ຂໍ້ຜິດພາດໃນການເປີດ Terminal',
        'recent_error_info': 'ຂໍ້ຜິດພາດໃນການດຶງຂໍ້ມູນໄຟລ໌',
        'open_user_data_folder': 'ສະແດງໄດເລກະທໍລີຂໍ້ມູນຜູ້ໃຊ້',

        # ============================================
        # 108. ລົບໜ້າຄູ່/ຄີກ
        # ============================================
        "pages_delete_even": "ລົບໜ້າຄູ່ທັງໝົດ",
        "pages_delete_odd":  "ລົບໜ້າຄີກທັງໝົດ",
        "progress_even_pages": "ກຳລັງລົບໜ້າຄູ່",
        "progress_odd_pages": "ກຳລັງລົບໜ້າຄີກ",
        "progress_mark_delete_even": "ໝາຍໜ້າຄູ່ຈຳນວນ {} ສຳລັບການລົບ",
        "progress_mark_delete_odd":  "ໝາຍໜ້າຄີກຈຳນວນ {} ສຳລັບການລົບ",
