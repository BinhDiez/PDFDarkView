...
Vyhledejte "Google Noto Fonts" nebo "Noto Sans" a klikněte na <strong>Nainstalovat</strong>.</p>
        ...
        'menu_recent_dirs': 'Adresáře...',
        'menu_recent_files': 'Soubory...',
        'recent_manage': 'Spravovat...',
        'recent_enable_tracking': 'Ukládat naposledy použité cesty (soukromí)',
        'recent_enable_info': 'Vypněte tuto možnost, aby se neukládaly žádné cesty',
        'recent_tracking_disabled': 'Sledování cest je vypnuto',
        'recent_enabled': 'povoleno',
        'recent_disabled': 'zakázáno',
        'recent_tracking_status': 'Sledování cest {0}',
        'recent_dialog_title': 'Naposledy použité cesty',
        'recent_tab_directories': 'Adresáře',
        'recent_tab_files': 'Soubory',
        'recent_dirs_instruction': 'Dvojklikem otevřete dialog pro výběr souboru v adresáři',
        'recent_files_instruction': 'Dvojklikem otevřete PDF přímo',
        'recent_no_directories': '(žádné uložené adresáře)',
        'recent_no_files': '(žádné uložené soubory)',
        'recent_default_current': '⭐ Výchozí: {0}',
        'recent_set_as_default': '⭐ Nastavit jako výchozí',
        'recent_default_set_title': 'Výchozí adresář nastaven',
        'recent_default_set_message': 'Adresář "{0}" byl nastaven jako výchozí pro otevírání PDF.',
        'recent_default_set_voice': 'Výchozí adresář byl nastaven',
        'recent_directory_not_found': 'Adresář nebyl nalezen',
        'recent_file_not_found': 'Soubor nebyl nalezen',
        'recent_remove_selected': 'Odebrat',
        'recent_remove_title': 'Odebrat cestu',
        'recent_remove_confirm': 'Opravdu chcete odebrat cestu "{0}" ze seznamu?',
        'recent_path_removed': 'Cesta byla odebrána',
        'recent_clear_all': 'Odebrat vše',
        'recent_clear_title': 'Odebrat všechny cesty',
        'recent_clear_confirm_type': 'Opravdu chcete smazat všech {0}?',
        'recent_cleared': 'Seznam byl vymazán',
        'recent_path_not_found_title': 'Cesta nebyla nalezena',
        'recent_path_not_found_message': 'Cesta "{0}" již neexistuje.',
        'recent_open_file': 'Otevřít soubor',
        'btn_open_recent': 'Otevřít',
        'recent_open_file_question': 'Chcete otevřít "{0}" jako PDF?',
        'recent_not_pdf': 'Vybraný soubor není PDF.',
        'recent_more_entries': 'Další položky...',
        'btn_remove': 'Odebrat',
        'btn_clear': 'Vymazat vše',
        'recent_context_open': 'Otevřít',
        'recent_context_reveal': 'Zobrazit ve Finderu',
        'recent_context_set_default': '⭐ Nastavit jako výchozí',
        'recent_context_open_terminal': '💻 Otevřít terminál',
        'recent_context_file_info': 'Informace o souboru',
        'recent_context_open_with_default': '📄 Otevřít výchozí aplikací',
        'recent_context_remove': 'Odebrat ze seznamu',
        'recent_context_clear_all': 'Odebrat vše',
        'recent_file_info_title': 'Informace o souboru',
        'recent_file_info_name': 'Název',
        'recent_file_info_path': 'Cesta',
        'recent_file_info_size': 'Velikost',
        'recent_file_info_modified': 'Změněno',
        'recent_file_info_pages': 'Stránky',
        'recent_error_reveal': 'Chyba při otevírání ve Finderu',
        'recent_error_terminal': 'Chyba při otevírání terminálu',
        'recent_error_info': 'Chyba při získávání informací o souboru',
        'open_user_data_folder': 'Zobrazit adresář uživatelských dat',

        # ============================================
        # 108. SMAZÁNÍ SUDÝCH/LICHÝCH STRAN
        # ============================================
        "pages_delete_even": "Smazat všechny sudé stránky",
        "pages_delete_odd":  "Smazat všechny liché stránky",
        "progress_even_pages": "Mažou se sudé stránky",
        "progress_odd_pages": "Mažou se liché stránky",
        "progress_mark_delete_even": "{} sudá(e) stránka(y) označeny ke smazání",
        "progress_mark_delete_odd":  "{} lichá(e) stránka(y) označeny ke smazání",
