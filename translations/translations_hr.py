...
Savjet: U kontekstnom izborniku možete prilagoditi postavke.
        ...
        'recent_enable_tracking': 'Spremi nedavno korištene staze (privatnost)',
        'recent_enable_info': 'Isključite ovu opciju kako ne biste spremali staze',
        'recent_tracking_disabled': 'Praćenje staza je onemogućeno',
        'recent_enabled': 'omogućeno',
        'recent_disabled': 'onemogućeno',
        'recent_tracking_status': 'Praćenje staza {0}',
        'recent_dialog_title': 'Nedavno korištene staze',
        'recent_tab_directories': 'Direktoriji',
        'recent_tab_files': 'Datoteke',
        'recent_dirs_instruction': 'Dvokliknite za otvaranje dijaloškog okvira za datoteke u direktoriju',
        'recent_files_instruction': 'Dvokliknite za izravno otvaranje PDF-a',
        'recent_no_directories': '(nema spremljenih direktorija)',
        'recent_no_files': '(nema spremljenih datoteka)',
        'recent_default_current': '⭐ Zadano: {0}',
        'recent_set_as_default': '⭐ Postavi kao zadano',
        'recent_default_set_title': 'Zadani direktorij postavljen',
        'recent_default_set_message': 'Direktorij "{0}" postavljen je kao zadani za otvaranje PDF-ova.',
        'recent_default_set_voice': 'Zadani direktorij postavljen',
        ...
        'recent_remove_title': 'Ukloni stazu',
        'recent_remove_confirm': 'Želite li zaista ukloniti stazu "{0}" s popisa?',
        'recent_path_removed': 'Staza je uklonjena',
        'recent_clear_all': 'Ukloni sve',
        'recent_clear_title': 'Ukloni sve staze',
        'recent_clear_confirm_type': 'Želite li zaista izbrisati sve {0}?',
        'recent_cleared': 'Popis je očišćen',
        'recent_path_not_found_title': 'Staza nije pronađena',
        'recent_path_not_found_message': 'Staza "{0}" više ne postoji.',
        'recent_open_file': 'Otvori datoteku',
        ...
        'recent_context_file_info': 'Informacije o datoteci',
        'recent_context_open_with_default': '📄 Otvori s zadanom aplikacijom',
        'recent_context_remove': 'Ukloni s popisa',
        'recent_context_clear_all': 'Ukloni sve',
        'recent_file_info_title': 'Informacije o datoteci',
        'recent_file_info_name': 'Ime',
        'recent_file_info_path': 'Staza',
        'recent_file_info_size': 'Veličina',
        'recent_file_info_modified': 'Izmijenjeno',
        'recent_file_info_pages': 'Stranice',
        'recent_error_reveal': 'Pogreška pri otvaranju u Finderu',
        'recent_error_terminal': 'Pogreška pri otvaranju terminala',
        'recent_error_info': 'Pogreška pri dohvaćanju informacija o datoteci',
        ...
        "progress_mark_delete_even": "{} parna(e) stranica(e) označeno za brisanje",
        "progress_mark_delete_odd":  "{} neparna(e) stranica(e) označeno za brisanje",
