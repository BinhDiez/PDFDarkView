...
Tips: Du kan justera inställningarna i snabbmenyn.
        ...
        # ============================================
        # 107. SENAST ANVÄNDA SÖKVÄGAR
        # ============================================

        'menu_recent': 'Senast använda',
        'menu_recent_dirs': 'Kataloger...',
        'menu_recent_files': 'Filer...',
        'recent_manage': 'Hantera...',
        'recent_enable_tracking': 'Spara senaste sökvägar (integritet)',
        'recent_enable_info': 'Inaktivera detta alternativ för att inte spara sökvägar',
        'recent_tracking_disabled': 'Sökvägsspårning är inaktiverad',
        'recent_enabled': 'aktiverad',
        'recent_disabled': 'inaktiverad',
        'recent_tracking_status': 'Sökvägsspårning {0}',
        'recent_dialog_title': 'Senast använda sökvägar',
        'recent_tab_directories': 'Kataloger',
        'recent_tab_files': 'Filer',
        'recent_dirs_instruction': 'Dubbelklicka för att öppna fildialog i katalogen',
        'recent_files_instruction': 'Dubbelklicka för att öppna PDF direkt',
        'recent_no_directories': '(inga sparade kataloger)',
        'recent_no_files': '(inga sparade filer)',
        'recent_default_current': '⭐ Standard: {0}',
        'recent_set_as_default': '⭐ Ange som standard',
        'recent_default_set_title': 'Standardkatalog har angetts',
        'recent_default_set_message': 'Katalogen "{0}" har angetts som standard för att öppna PDF-filer.',
        'recent_default_set_voice': 'Standardkatalog har angetts',
        'recent_directory_not_found': 'Katalog hittades inte',
        'recent_file_not_found': 'Fil hittades inte',
        'recent_remove_selected': 'Ta bort',
        'recent_remove_title': 'Ta bort sökväg',
        'recent_remove_confirm': 'Vill du verkligen ta bort sökvägen "{0}" från listan?',
        'recent_path_removed': 'Sökväg har tagits bort',
        'recent_clear_all': 'Ta bort alla',
        'recent_clear_title': 'Ta bort alla sökvägar',
        'recent_clear_confirm_type': 'Vill du verkligen ta bort alla {0}?',
        'recent_cleared': 'Listan har rensats',
        'recent_path_not_found_title': 'Sökväg hittades inte',
        'recent_path_not_found_message': 'Sökvägen "{0}" finns inte längre.',
        'recent_open_file': 'Öppna fil',
        'btn_open_recent': 'Öppna',
        'recent_open_file_question': 'Vill du öppna "{0}" som PDF?',
        'recent_not_pdf': 'Den valda filen är inte en PDF.',
        'recent_more_entries': 'Fler poster...',
        'btn_remove': 'Ta bort',
        'btn_clear': 'Rensa alla',
        'recent_context_open': 'Öppna',
        'recent_context_reveal': 'Visa i Finder',
        'recent_context_set_default': '⭐ Ange som standard',
        'recent_context_open_terminal': '💻 Öppna terminal',
        'recent_context_file_info': 'Filinfo',
        'recent_context_open_with_default': '📄 Öppna med standardapp',
        'recent_context_remove': 'Ta bort från listan',
        'recent_context_clear_all': 'Ta bort alla',
        'recent_file_info_title': 'Filinformation',
        'recent_file_info_name': 'Namn',
        'recent_file_info_path': 'Sökväg',
        'recent_file_info_size': 'Storlek',
        'recent_file_info_modified': 'Ändrad',
        'recent_file_info_pages': 'Sidor',
        'recent_error_reveal': 'Fel vid öppning i Finder',
        'recent_error_terminal': 'Fel vid öppning av terminal',
        'recent_error_info': 'Fel vid hämtning av filinfo',
        'open_user_data_folder': 'Visa användardatakatalog',

        # ============================================
        # 108. TA BORT JÄMNA/OJÄMNA SIDOR
        # ============================================
        "pages_delete_even": "Ta bort alla jämna sidor",
        "pages_delete_odd":  "Ta bort alla ojämna sidor",
        "progress_even_pages": "Tar bort jämna sidor",
        "progress_odd_pages": "Tar bort ojämna sidor",
        "progress_mark_delete_even": "{} jämn(a) sida(or) markerad(a) för borttagning",
        "progress_mark_delete_odd":  "{} ojämn(a) sida(or) markerad(a) för borttagning",
