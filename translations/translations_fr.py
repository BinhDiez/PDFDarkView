...
Astuce : vous pouvez ajuster les paramètres dans le menu contextuel.
        ...
        'menu_recent': 'Récemment utilisés',
        'menu_recent_dirs': 'Répertoires...',
        'menu_recent_files': 'Fichiers...',
        'recent_manage': 'Gérer...',
        'recent_enable_tracking': 'Enregistrer les chemins récents (confidentialité)',
        'recent_enable_info': 'Désactivez cette option pour ne pas enregistrer de chemins',
        'recent_tracking_disabled': 'Suivi des chemins désactivé',
        'recent_enabled': 'activé',
        'recent_disabled': 'désactivé',
        'recent_tracking_status': 'Suivi des chemins {0}',
        'recent_dialog_title': 'Chemins récents',
        'recent_tab_directories': 'Répertoires',
        'recent_tab_files': 'Fichiers',
        'recent_dirs_instruction': 'Double-cliquez pour ouvrir la boîte de dialogue de fichier dans le répertoire',
        'recent_files_instruction': 'Double-cliquez pour ouvrir le PDF directement',
        'recent_no_directories': '(aucun répertoire enregistré)',
        'recent_no_files': '(aucun fichier enregistré)',
        'recent_default_current': '⭐ Par défaut : {0}',
        'recent_set_as_default': '⭐ Définir par défaut',
        'recent_default_set_title': 'Répertoire par défaut défini',
        'recent_default_set_message': 'Le répertoire "{0}" a été défini comme répertoire par défaut pour l\'ouverture des PDF.',
        'recent_default_set_voice': 'Répertoire par défaut défini',
        'recent_directory_not_found': 'Répertoire non trouvé',
        'recent_file_not_found': 'Fichier non trouvé',
        'recent_remove_selected': 'Supprimer',
        'recent_remove_title': 'Supprimer le chemin',
        'recent_remove_confirm': 'Voulez-vous vraiment supprimer le chemin "{0}" de la liste ?',
        'recent_path_removed': 'Chemin supprimé',
        'recent_clear_all': 'Tout supprimer',
        'recent_clear_title': 'Supprimer tous les chemins',
        'recent_clear_confirm_type': 'Voulez-vous vraiment supprimer tous les {0} ?',
        'recent_cleared': 'Liste effacée',
        'recent_path_not_found_title': 'Chemin non trouvé',
        'recent_path_not_found_message': 'Le chemin "{0}" n\'existe plus.',
        'recent_open_file': 'Ouvrir un fichier',
        'btn_open_recent': 'Ouvrir',
        'recent_open_file_question': 'Voulez-vous ouvrir "{0}" en tant que PDF ?',
        'recent_not_pdf': 'Le fichier sélectionné n\'est pas un PDF.',
        'recent_more_entries': 'Plus d\'entrées...',
        'btn_remove': 'Supprimer',
        'btn_clear': 'Tout effacer',
        'recent_context_open': 'Ouvrir',
        'recent_context_reveal': 'Afficher dans le Finder',
        'recent_context_set_default': '⭐ Définir par défaut',
        'recent_context_open_terminal': '💻 Ouvrir le terminal',
        'recent_context_file_info': 'Informations sur le fichier',
        'recent_context_open_with_default': '📄 Ouvrir avec l\'application par défaut',
        'recent_context_remove': 'Supprimer de la liste',
        'recent_context_clear_all': 'Tout supprimer',
        'recent_file_info_title': 'Informations sur le fichier',
        'recent_file_info_name': 'Nom',
        'recent_file_info_path': 'Chemin',
        'recent_file_info_size': 'Taille',
        'recent_file_info_modified': 'Modifié',
        'recent_file_info_pages': 'Pages',
        'recent_error_reveal': 'Erreur lors de l\'ouverture dans le Finder',
        'recent_error_terminal': 'Erreur lors de l\'ouverture du terminal',
        'recent_error_info': 'Erreur lors de la récupération des informations du fichier',
        'open_user_data_folder': 'Afficher le répertoire des données utilisateur',

        # ============================================
        # 108. SUPPRIMER LES PAGES PAIRES/IMPAIRES
        # ============================================
        "pages_delete_even": "Supprimer toutes les pages paires",
        "pages_delete_odd":  "Supprimer toutes les pages impaires",
        "progress_even_pages": "Suppression des pages paires",
        "progress_odd_pages": "Suppression des pages impaires",
        "progress_mark_delete_even": "{} page(s) paire(s) marquée(s) pour suppression",
        "progress_mark_delete_odd":  "{} page(s) impaire(s) marquée(s) pour suppression",
