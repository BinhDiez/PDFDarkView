...
def load_vietnamese_strings():
    ...
    return {
        ...
        # 19.1 TEXTEINGABE
        # ============================================
        'text_input': "Nhập văn bản và quản lý mẫu",
...
Mẹo: Bạn có thể điều chỉnh cài đặt trong menu ngữ cảnh.
        ...
        # ============================================
        # 108. XÓA TRANG CHẴN/LẺ
        # ============================================
        "pages_delete_even": "Xóa tất cả trang chẵn",
        "pages_delete_odd":  "Xóa tất cả trang lẻ",
        "progress_even_pages": "Đang xóa trang chẵn",
        "progress_odd_pages": "Đang xóa trang lẻ",
        "progress_mark_delete_even": "Đã đánh dấu {} trang chẵn để xóa",
        "progress_mark_delete_odd":  "Đã đánh dấu {} trang lẻ để xóa",

        # ============================================
        # 109. BENUTZERNAME IN SUFFIXEN
        # ============================================
        # FilenameSettingsDialog - Tên người dùng trong hậu tố
        "username_in_suffix": "Tên người dùng trong hậu tố",
        "username_in_suffix_enable": "Thêm tên người dùng vào hậu tố",
        "username_label": "Tên người dùng:",
        "username_placeholder": "Ví dụ: N.V.Bình",
        "username_hint": "Tên người dùng sẽ được thêm vào tất cả các hậu tố (ví dụ: _có_Văn_bản).\nVí dụ: Tài_liệu_có_Văn_bản_N.V.Bình.pdf",
        "username_reset": "Đặt lại",
