...
เคล็ดลับ: ในเมนูบริบทคุณสามารถปรับการตั้งค่าได้
    ...
    """,
        ...
        'menu_recent': 'ที่ใช้ล่าสุด',
        'menu_recent_dirs': 'ไดเรกทอรี...',
        'menu_recent_files': 'ไฟล์...',
        'recent_manage': 'จัดการ...',
        'recent_enable_tracking': 'บันทึกพาธที่ใช้ล่าสุด (ความเป็นส่วนตัว)',
        'recent_enable_info': 'ปิดตัวเลือกนี้เพื่อไม่บันทึกพาธ',
        'recent_tracking_disabled': 'การติดตามพาธถูกปิดใช้งาน',
        'recent_enabled': 'เปิดใช้งาน',
        'recent_disabled': 'ปิดใช้งาน',
        'recent_tracking_status': 'การติดตามพาธ {0}',
        'recent_dialog_title': 'พาธที่ใช้ล่าสุด',
        'recent_tab_directories': 'ไดเรกทอรี',
        'recent_tab_files': 'ไฟล์',
        'recent_dirs_instruction': 'ดับเบิลคลิกเพื่อเปิดกล่องโต้ตอบไฟล์ในไดเรกทอรี',
        'recent_files_instruction': 'ดับเบิลคลิกเพื่อเปิด PDF โดยตรง',
        'recent_no_directories': '(ไม่มีไดเรกทอรีที่บันทึก)',
        'recent_no_files': '(ไม่มีไฟล์ที่บันทึก)',
        'recent_default_current': '⭐ ค่าเริ่มต้น: {0}',
        'recent_set_as_default': '⭐ ตั้งเป็นค่าเริ่มต้น',
        'recent_default_set_title': 'ตั้งค่าไดเรกทอรีเริ่มต้นแล้ว',
        'recent_default_set_message': 'ไดเรกทอรี "{0}" ถูกตั้งเป็นค่าเริ่มต้นสำหรับการเปิด PDF',
        'recent_default_set_voice': 'ตั้งค่าไดเรกทอรีเริ่มต้นแล้ว',
        'recent_directory_not_found': 'ไม่พบไดเรกทอรี',
        'recent_file_not_found': 'ไม่พบไฟล์',
        'recent_remove_selected': 'ลบ',
        'recent_remove_title': 'ลบพาธ',
        'recent_remove_confirm': 'คุณแน่ใจว่าต้องการลบพาธ "{0}" ออกจากรายการ?',
        'recent_path_removed': 'ลบพาธแล้ว',
        'recent_clear_all': 'ลบทั้งหมด',
        'recent_clear_title': 'ลบพาธทั้งหมด',
        'recent_clear_confirm_type': 'คุณแน่ใจว่าต้องการลบ {0} ทั้งหมด?',
        'recent_cleared': 'ล้างรายการแล้ว',
        'recent_path_not_found_title': 'ไม่พบพาธ',
        'recent_path_not_found_message': 'พาธ "{0}" ไม่มีอยู่แล้ว',
        'recent_open_file': 'เปิดไฟล์',
        'btn_open_recent': 'เปิด',
        'recent_open_file_question': 'คุณต้องการเปิด "{0}" เป็น PDF หรือไม่?',
        'recent_not_pdf': 'ไฟล์ที่เลือกไม่ใช่ PDF',
        'recent_more_entries': 'รายการเพิ่มเติม...',
        'btn_remove': 'ลบ',
        'btn_clear': 'ล้างทั้งหมด',
        'recent_context_open': 'เปิด',
        'recent_context_reveal': 'แสดงใน Finder',
        'recent_context_set_default': '⭐ ตั้งเป็นค่าเริ่มต้น',
        'recent_context_open_terminal': '💻 เปิดเทอร์มินัล',
        'recent_context_file_info': 'ข้อมูลไฟล์',
        'recent_context_open_with_default': '📄 เปิดด้วยแอปเริ่มต้น',
        'recent_context_remove': 'ลบออกรายการ',
        'recent_context_clear_all': 'ลบทั้งหมด',
        'recent_file_info_title': 'ข้อมูลไฟล์',
        'recent_file_info_name': 'ชื่อ',
        'recent_file_info_path': 'พาธ',
        'recent_file_info_size': 'ขนาด',
        'recent_file_info_modified': 'แก้ไขเมื่อ',
        'recent_file_info_pages': 'หน้า',
        'recent_error_reveal': 'ข้อผิดพลาดในการเปิดใน Finder',
        'recent_error_terminal': 'ข้อผิดพลาดในการเปิดเทอร์มินัล',
        'recent_error_info': 'ข้อผิดพลาดในการดึงข้อมูลไฟล์',
        'open_user_data_folder': 'แสดงไดเรกทอรีข้อมูลผู้ใช้',

        # ============================================
        # 108. ลบหน้าคู่/หน้าคี่
        # ============================================
        "pages_delete_even": "ลบหน้าคู่ทั้งหมด",
        "pages_delete_odd":  "ลบหน้าคี่ทั้งหมด",
        "progress_even_pages": "กำลังลบหน้าคู่",
        "progress_odd_pages": "กำลังลบหน้าคี่",
        "progress_mark_delete_even": "ทำเครื่องหมายหน้าคู่ {} หน้าเพื่อลบ",
        "progress_mark_delete_odd":  "ทำเครื่องหมายหน้าคี่ {} หน้าเพื่อลบ",
