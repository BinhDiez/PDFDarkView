...
Consiglio: è possibile regolare le impostazioni nel menu contestuale.
        ...
        # ============================================
        # 107. PERCORSI RECENTI
        # ============================================

        'menu_recent': 'Usati di recente',
        'menu_recent_dirs': 'Directory...',
        'menu_recent_files': 'File...',
        'recent_manage': 'Gestisci...',
        'recent_enable_tracking': 'Salva percorsi recenti (privacy)',
        'recent_enable_info': 'Disabilita questa opzione per non salvare percorsi',
        'recent_tracking_disabled': 'Tracciamento percorsi disabilitato',
        'recent_enabled': 'abilitato',
        'recent_disabled': 'disabilitato',
        'recent_tracking_status': 'Tracciamento percorsi {0}',
        'recent_dialog_title': 'Percorsi recenti',
        'recent_tab_directories': 'Directory',
        'recent_tab_files': 'File',
        'recent_dirs_instruction': 'Doppio clic per aprire la finestra di dialogo file nella directory',
        'recent_files_instruction': 'Doppio clic per aprire il PDF direttamente',
        'recent_no_directories': '(nessuna directory salvata)',
        'recent_no_files': '(nessun file salvato)',
        'recent_default_current': '⭐ Predefinito: {0}',
        'recent_set_as_default': '⭐ Imposta come predefinito',
        'recent_default_set_title': 'Directory predefinita impostata',
        'recent_default_set_message': 'La directory "{0}" è stata impostata come predefinita per l\'apertura dei PDF.',
        'recent_default_set_voice': 'Directory predefinita impostata',
        'recent_directory_not_found': 'Directory non trovata',
        'recent_file_not_found': 'File non trovato',
        'recent_remove_selected': 'Rimuovi',
        'recent_remove_title': 'Rimuovi percorso',
        'recent_remove_confirm': 'Vuoi davvero rimuovere il percorso "{0}" dall\'elenco?',
        'recent_path_removed': 'Percorso rimosso',
        'recent_clear_all': 'Rimuovi tutto',
        'recent_clear_title': 'Rimuovi tutti i percorsi',
        'recent_clear_confirm_type': 'Vuoi davvero eliminare tutti i {0}?',
        'recent_cleared': 'Elenco cancellato',
        'recent_path_not_found_title': 'Percorso non trovato',
        'recent_path_not_found_message': 'Il percorso "{0}" non esiste più.',
        'recent_open_file': 'Apri file',
        'btn_open_recent': 'Apri',
        'recent_open_file_question': 'Vuoi aprire "{0}" come PDF?',
        'recent_not_pdf': 'Il file selezionato non è un PDF.',
        'recent_more_entries': 'Altre voci...',
        'btn_remove': 'Rimuovi',
        'btn_clear': 'Cancella tutto',
        'recent_context_open': 'Apri',
        'recent_context_reveal': 'Mostra nel Finder',
        'recent_context_set_default': '⭐ Imposta come predefinito',
        'recent_context_open_terminal': '💻 Apri terminale',
        'recent_context_file_info': 'Informazioni file',
        'recent_context_open_with_default': '📄 Apri con l\'app predefinita',
        'recent_context_remove': 'Rimuovi dall\'elenco',
        'recent_context_clear_all': 'Rimuovi tutto',
        'recent_file_info_title': 'Informazioni file',
        'recent_file_info_name': 'Nome',
        'recent_file_info_path': 'Percorso',
        'recent_file_info_size': 'Dimensione',
        'recent_file_info_modified': 'Modificato',
        'recent_file_info_pages': 'Pagine',
        'recent_error_reveal': 'Errore durante l\'apertura nel Finder',
        'recent_error_terminal': 'Errore durante l\'apertura del terminale',
        'recent_error_info': 'Errore durante il recupero delle informazioni del file',
        'open_user_data_folder': 'Mostra la directory dei dati utente',

        # ============================================
        # 108. ELIMINA PAGINE PARI/DISPARI
        # ============================================
        "pages_delete_even": "Elimina tutte le pagine pari",
        "pages_delete_odd":  "Elimina tutte le pagine dispari",
        "progress_even_pages": "Eliminazione pagine pari in corso",
        "progress_odd_pages": "Eliminazione pagine dispari in corso",
        "progress_mark_delete_even": "{} pagina(e) pari segnate per l\'eliminazione",
        "progress_mark_delete_odd":  "{} pagina(e) dispari segnate per l\'eliminazione",
