...
Vinkki: Voit muokata asetuksia pikavalikosta.
        ...
        # ============================================
        # 107. ÄSKEN KÄYTETYT POLUT
        # ============================================

        'menu_recent': 'Äsken käytetyt',
        'menu_recent_dirs': 'Hakemistot...',
        'menu_recent_files': 'Tiedostot...',
        'recent_manage': 'Hallitse...',
        'recent_enable_tracking': 'Tallenna äsken käytetyt polut (yksityisyys)',
        'recent_enable_info': 'Poista tämä asetus käytöstä, jotta polkuja ei tallenneta',
        'recent_tracking_disabled': 'Polkujen seuranta on poistettu käytöstä',
        'recent_enabled': 'käytössä',
        'recent_disabled': 'poissa käytöstä',
        'recent_tracking_status': 'Polkujen seuranta {0}',
        'recent_dialog_title': 'Äsken käytetyt polut',
        'recent_tab_directories': 'Hakemistot',
        'recent_tab_files': 'Tiedostot',
        'recent_dirs_instruction': 'Avaa tiedostovalintaikkuna hakemistossa kaksoisnapsauttamalla',
        'recent_files_instruction': 'Avaa PDF suoraan kaksoisnapsauttamalla',
        'recent_no_directories': '(ei tallennettuja hakemistoja)',
        'recent_no_files': '(ei tallennettuja tiedostoja)',
        'recent_default_current': '⭐ Oletus: {0}',
        'recent_set_as_default': '⭐ Aseta oletukseksi',
        'recent_default_set_title': 'Oletushakemisto asetettu',
        'recent_default_set_message': 'Hakemisto "{0}" on asetettu PDF-tiedostojen avaamisen oletushakemistoksi.',
        'recent_default_set_voice': 'Oletushakemisto on asetettu',
        'recent_directory_not_found': 'Hakemistoa ei löytynyt',
        'recent_file_not_found': 'Tiedostoa ei löytynyt',
        'recent_remove_selected': 'Poista',
        'recent_remove_title': 'Poista polku',
        'recent_remove_confirm': 'Haluatko todella poistaa polun "{0}" listalta?',
        'recent_path_removed': 'Polku on poistettu',
        'recent_clear_all': 'Poista kaikki',
        'recent_clear_title': 'Poista kaikki polut',
        'recent_clear_confirm_type': 'Haluatko todella poistaa kaikki {0}?',
        'recent_cleared': 'Lista on tyhjennetty',
        'recent_path_not_found_title': 'Polkua ei löytynyt',
        'recent_path_not_found_message': 'Polkua "{0}" ei ole enää olemassa.',
        'recent_open_file': 'Avaa tiedosto',
        'btn_open_recent': 'Avaa',
        'recent_open_file_question': 'Haluatko avata "{0}" PDF-tiedostona?',
        'recent_not_pdf': 'Valittu tiedosto ei ole PDF.',
        'recent_more_entries': 'Lisää kohteita...',
        'btn_remove': 'Poista',
        'btn_clear': 'Tyhjennä kaikki',
        'recent_context_open': 'Avaa',
        'recent_context_reveal': 'Näytä Finderissa',
        'recent_context_set_default': '⭐ Aseta oletukseksi',
        'recent_context_open_terminal': '💻 Avaa pääte',
        'recent_context_file_info': 'Tiedoston tiedot',
        'recent_context_open_with_default': '📄 Avaa oletussovelluksella',
        'recent_context_remove': 'Poista listalta',
        'recent_context_clear_all': 'Poista kaikki',
        'recent_file_info_title': 'Tiedoston tiedot',
        'recent_file_info_name': 'Nimi',
        'recent_file_info_path': 'Polku',
        'recent_file_info_size': 'Koko',
        'recent_file_info_modified': 'Muokattu',
        'recent_file_info_pages': 'Sivut',
        'recent_error_reveal': 'Virhe avattaessa Finderissa',
        'recent_error_terminal': 'Virhe avattaessa päätettä',
        'recent_error_info': 'Virhe haettaessa tiedoston tietoja',
        'open_user_data_folder': 'Näytä käyttäjän datakansio',

        # ============================================
        # 108. PARILLISTEN/PARITTOMIEN SIVUJEN POISTO
        # ============================================
        "pages_delete_even": "Poista kaikki parilliset sivut",
        "pages_delete_odd":  "Poista kaikki parittomat sivut",
        "progress_even_pages": "Poistetaan parillisia sivuja",
        "progress_odd_pages": "Poistetaan parittomia sivuja",
        "progress_mark_delete_even": "{} parillista sivua merkitty poistettavaksi",
        "progress_mark_delete_odd":  "{} paritonta sivua merkitty poistettavaksi",
