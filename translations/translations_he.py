...
טיפ: בתפריט ההקשר תוכל להתאים את ההגדרות.
        ...
        'menu_recent': 'שהיו בשימוש לאחרונה',
        'menu_recent_dirs': 'ספריות...',
        'menu_recent_files': 'קבצים...',
        'recent_manage': 'ניהול...',
        'recent_enable_tracking': 'שמור נתיבים אחרונים (פרטיות)',
        'recent_enable_info': 'בטל אפשרות זו כדי לא לשמור נתיבים',
        'recent_tracking_disabled': 'מעקב נתיבים מושבת',
        'recent_enabled': 'מופעל',
        'recent_disabled': 'מושבת',
        'recent_tracking_status': 'מעקב נתיבים {0}',
        'recent_dialog_title': 'נתיבים אחרונים',
        'recent_tab_directories': 'ספריות',
        'recent_tab_files': 'קבצים',
        'recent_dirs_instruction': 'לחץ פעמיים לפתיחת תיבת דו-שיח קובץ בספרייה',
        'recent_files_instruction': 'לחץ פעמיים לפתיחת PDF ישירות',
        'recent_no_directories': '(אין ספריות שמורות)',
        'recent_no_files': '(אין קבצים שמורים)',
        'recent_default_current': '⭐ ברירת מחדל: {0}',
        'recent_set_as_default': '⭐ הגדר כברירת מחדל',
        'recent_default_set_title': 'ספריית ברירת מחדל נקבעה',
        'recent_default_set_message': 'הספרייה "{0}" נקבעה כברירת מחדל לפתיחת קבצי PDF.',
        'recent_default_set_voice': 'ספריית ברירת מחדל נקבעה',
        'recent_directory_not_found': 'הספרייה לא נמצאה',
        'recent_file_not_found': 'הקובץ לא נמצא',
        'recent_remove_selected': 'הסר',
        'recent_remove_title': 'הסר נתיב',
        'recent_remove_confirm': 'האם אתה באמת רוצה להסיר את הנתיב "{0}" מהרשימה?',
        'recent_path_removed': 'הנתיב הוסר',
        'recent_clear_all': 'הסר הכל',
        'recent_clear_title': 'הסר את כל הנתיבים',
        'recent_clear_confirm_type': 'האם אתה באמת רוצה למחוק את כל {0}?',
        'recent_cleared': 'הרשימה נוקתה',
        'recent_path_not_found_title': 'הנתיב לא נמצא',
        'recent_path_not_found_message': 'הנתיב "{0}" אינו קיים יותר.',
        'recent_open_file': 'פתח קובץ',
        'btn_open_recent': 'פתח',
        'recent_open_file_question': 'האם ברצונך לפתוח את "{0}" כ-PDF?',
        'recent_not_pdf': 'הקובץ הנבחר אינו PDF.',
        'recent_more_entries': 'עוד רשומות...',
        'btn_remove': 'הסר',
        'btn_clear': 'נקה הכל',
        'recent_context_open': 'פתח',
        'recent_context_reveal': 'הצג ב-Finder',
        'recent_context_set_default': '⭐ הגדר כברירת מחדל',
        'recent_context_open_terminal': '💻 פתח טרמינל',
        'recent_context_file_info': 'מידע על הקובץ',
        'recent_context_open_with_default': '📄 פתח עם יישום ברירת המחדל',
        'recent_context_remove': 'הסר מהרשימה',
        'recent_context_clear_all': 'הסר הכל',
        'recent_file_info_title': 'מידע על הקובץ',
        'recent_file_info_name': 'שם',
        'recent_file_info_path': 'נתיב',
        'recent_file_info_size': 'גודל',
        'recent_file_info_modified': 'שונה לאחרונה',
        'recent_file_info_pages': 'עמודים',
        'recent_error_reveal': 'שגיאה בפתיחה ב-Finder',
        'recent_error_terminal': 'שגיאה בפתיחת טרמינל',
        'recent_error_info': 'שגיאה בשליפת מידע על הקובץ',
        'open_user_data_folder': 'הצג ספריית נתוני המשתמש',

        # ============================================
        # 108. מחיקת עמודים זוגיים/אי-זוגיים
        # ============================================
        "pages_delete_even": "מחק את כל העמודים הזוגיים",
        "pages_delete_odd":  "מחק את כל העמודים האי-זוגיים",
        "progress_even_pages": "מוחק עמודים זוגיים",
        "progress_odd_pages": "מוחק עמודים אי-זוגיים",
        "progress_mark_delete_even": "{} עמוד(ים) זוגי(ים) סומנו למחיקה",
        "progress_mark_delete_odd":  "{} עמוד(ים) אי-זוגי(ים) סומנו למחיקה",
