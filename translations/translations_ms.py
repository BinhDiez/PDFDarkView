...
Petua: Dalam menu konteks, anda boleh melaraskan tetapan.
        ...
        # ============================================
        # 107. LALUAN YANG BARU DIGUNAKAN
        # ============================================

        'menu_recent': 'Baru digunakan',
        'menu_recent_dirs': 'Direktori...',
        'menu_recent_files': 'Fail...',
        'recent_manage': 'Urus...',
        'recent_enable_tracking': 'Simpan laluan terkini (privasi)',
        'recent_enable_info': 'Nyahlkan pilihan ini untuk tidak menyimpan laluan',
        'recent_tracking_disabled': 'Penjejakan laluan dinyahaktifkan',
        'recent_enabled': 'diaktifkan',
        'recent_disabled': 'dinyahaktifkan',
        'recent_tracking_status': 'Penjejakan laluan {0}',
        'recent_dialog_title': 'Laluan terkini',
        'recent_tab_directories': 'Direktori',
        'recent_tab_files': 'Fail',
        'recent_dirs_instruction': 'Klik dua kali untuk membuka dialog fail dalam direktori',
        'recent_files_instruction': 'Klik dua kali untuk membuka PDF secara terus',
        'recent_no_directories': '(tiada direktori disimpan)',
        'recent_no_files': '(tiada fail disimpan)',
        'recent_default_current': '⭐ Lalai: {0}',
        'recent_set_as_default': '⭐ Tetapkan sebagai lalai',
        'recent_default_set_title': 'Direktori lalai ditetapkan',
        'recent_default_set_message': 'Direktori "{0}" telah ditetapkan sebagai lalai untuk membuka PDF.',
        'recent_default_set_voice': 'Direktori lalai telah ditetapkan',
        'recent_directory_not_found': 'Direktori tidak dijumpai',
        'recent_file_not_found': 'Fail tidak dijumpai',
        'recent_remove_selected': 'Buang',
        'recent_remove_title': 'Buang laluan',
        'recent_remove_confirm': 'Adakah anda pasti mahu membuang laluan "{0}" daripada senarai?',
        'recent_path_removed': 'Laluan telah dibuang',
        'recent_clear_all': 'Buang semua',
        'recent_clear_title': 'Buang semua laluan',
        'recent_clear_confirm_type': 'Adakah anda pasti mahu memadam semua {0}?',
        'recent_cleared': 'Senarai telah dibersihkan',
        'recent_path_not_found_title': 'Laluan tidak dijumpai',
        'recent_path_not_found_message': 'Laluan "{0}" tidak lagi wujud.',
        'recent_open_file': 'Buka fail',
        'btn_open_recent': 'Buka',
        'recent_open_file_question': 'Adakah anda mahu membuka "{0}" sebagai PDF?',
        'recent_not_pdf': 'Fail yang dipilih bukan PDF.',
        'recent_more_entries': 'Entri lanjut...',
        'btn_remove': 'Buang',
        'btn_clear': 'Bersihkan semua',
        'recent_context_open': 'Buka',
        'recent_context_reveal': 'Tunjukkan dalam Finder',
        'recent_context_set_default': '⭐ Tetapkan sebagai lalai',
        'recent_context_open_terminal': '💻 Buka Terminal',
        'recent_context_file_info': 'Maklumat fail',
        'recent_context_open_with_default': '📄 Buka dengan aplikasi lalai',
        'recent_context_remove': 'Buang daripada senarai',
        'recent_context_clear_all': 'Buang semua',
        'recent_file_info_title': 'Maklumat fail',
        'recent_file_info_name': 'Nama',
        'recent_file_info_path': 'Laluan',
        'recent_file_info_size': 'Saiz',
        'recent_file_info_modified': 'Diubah suai',
        'recent_file_info_pages': 'Halaman',
        'recent_error_reveal': 'Ralat membuka dalam Finder',
        'recent_error_terminal': 'Ralat membuka Terminal',
        'recent_error_info': 'Ralat mendapatkan maklumat fail',
        'open_user_data_folder': 'Tunjukkan direktori data pengguna',

        # ============================================
        # 108. PADAM HALAMAN GENAP/GANJIL
        # ============================================
        "pages_delete_even": "Padam semua halaman genap",
        "pages_delete_odd":  "Padam semua halaman ganjil",
        "progress_even_pages": "Memadam halaman genap",
        "progress_odd_pages": "Memadam halaman ganjil",
        "progress_mark_delete_even": "{} halaman genap ditanda untuk dipadam",
        "progress_mark_delete_odd":  "{} halaman ganjil ditanda untuk dipadam",
