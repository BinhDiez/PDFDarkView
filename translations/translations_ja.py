...
ヒント: コンテキストメニューで設定を調整できます。
        ...
        'menu_recent': '最近使用した項目',
        'menu_recent_dirs': 'ディレクトリ...',
        'menu_recent_files': 'ファイル...',
        'recent_manage': '管理...',
        'recent_enable_tracking': '最近使用したパスを保存する（プライバシー）',
        'recent_enable_info': 'パスを保存しない場合はこのオプションを無効にしてください',
        'recent_tracking_disabled': 'パストラッキングは無効です',
        'recent_enabled': '有効',
        'recent_disabled': '無効',
        'recent_tracking_status': 'パストラッキング {0}',
        'recent_dialog_title': '最近使用したパス',
        'recent_tab_directories': 'ディレクトリ',
        'recent_tab_files': 'ファイル',
        'recent_dirs_instruction': 'ダブルクリックでディレクトリ内のファイルダイアログを開く',
        'recent_files_instruction': 'ダブルクリックでPDFを直接開く',
        'recent_no_directories': '(保存されたディレクトリはありません)',
        'recent_no_files': '(保存されたファイルはありません)',
        'recent_default_current': '⭐ デフォルト: {0}',
        'recent_set_as_default': '⭐ デフォルトとして設定',
        'recent_default_set_title': 'デフォルトディレクトリが設定されました',
        'recent_default_set_message': 'ディレクトリ "{0}" がPDFを開くデフォルトとして設定されました。',
        'recent_default_set_voice': 'デフォルトディレクトリが設定されました',
        'recent_directory_not_found': 'ディレクトリが見つかりません',
        'recent_file_not_found': 'ファイルが見つかりません',
        'recent_remove_selected': '削除',
        'recent_remove_title': 'パスを削除',
        'recent_remove_confirm': 'パス "{0}" をリストから削除してもよろしいですか？',
        'recent_path_removed': 'パスが削除されました',
        'recent_clear_all': 'すべて削除',
        'recent_clear_title': 'すべてのパスを削除',
        'recent_clear_confirm_type': 'すべての {0} を削除してもよろしいですか？',
        'recent_cleared': 'リストがクリアされました',
        'recent_path_not_found_title': 'パスが見つかりません',
        'recent_path_not_found_message': 'パス "{0}" は存在しません。',
        'recent_open_file': 'ファイルを開く',
        'btn_open_recent': '開く',
        'recent_open_file_question': '"{0}" をPDFとして開きますか？',
        'recent_not_pdf': '選択されたファイルはPDFではありません。',
        'recent_more_entries': 'さらに表示...',
        'btn_remove': '削除',
        'btn_clear': 'すべてクリア',
        'recent_context_open': '開く',
        'recent_context_reveal': 'Finderで表示',
        'recent_context_set_default': '⭐ デフォルトとして設定',
        'recent_context_open_terminal': '💻 ターミナルを開く',
        'recent_context_file_info': 'ファイル情報',
        'recent_context_open_with_default': '📄 デフォルトアプリで開く',
        'recent_context_remove': 'リストから削除',
        'recent_context_clear_all': 'すべて削除',
        'recent_file_info_title': 'ファイル情報',
        'recent_file_info_name': '名前',
        'recent_file_info_path': 'パス',
        'recent_file_info_size': 'サイズ',
        'recent_file_info_modified': '更新日',
        'recent_file_info_pages': 'ページ数',
        'recent_error_reveal': 'Finderで開く際にエラーが発生しました',
        'recent_error_terminal': 'ターミナルを開く際にエラーが発生しました',
        'recent_error_info': 'ファイル情報の取得中にエラーが発生しました',
        'open_user_data_folder': 'ユーザーデータディレクトリを表示',

        # ============================================
        # 108. 偶数/奇数ページの削除
        # ============================================
        "pages_delete_even": "すべての偶数ページを削除",
        "pages_delete_odd":  "すべての奇数ページを削除",
        "progress_even_pages": "偶数ページを削除中",
        "progress_odd_pages": "奇数ページを削除中",
        "progress_mark_delete_even": "{} ページの偶数ページが削除対象としてマークされました",
        "progress_mark_delete_odd":  "{} ページの奇数ページが削除対象としてマークされました",
