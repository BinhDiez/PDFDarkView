...
Këshillë: Në menynë e kontekstit mund të rregulloni cilësimet.
      ...
      # ============================================
        ...
        # ============================================
        # 107. RRUGËT E PËRDORURA SË FUNDMI
        # ============================================

        'menu_recent': 'Të përdorura së fundmi',
        'menu_recent_dirs': 'Direktoritë...',
        'menu_recent_files': 'Skedarët...',
        'recent_manage': 'Menaxho...',
        'recent_enable_tracking': 'Ruaj rrugët e fundit (privatësi)',
        'recent_enable_info': 'Çaktivizoni këtë opsion për të mos ruajtur rrugë',
        'recent_tracking_disabled': 'Gjurmimi i rrugëve është çaktivizuar',
        'recent_enabled': 'aktivizuar',
        'recent_disabled': 'çaktivizuar',
        'recent_tracking_status': 'Gjurmimi i rrugëve {0}',
        'recent_dialog_title': 'Rrugët e përdorura së fundmi',
        'recent_tab_directories': 'Direktoritë',
        'recent_tab_files': 'Skedarët',
        'recent_dirs_instruction': 'Klikoni dy herë për të hapur dialogun e skedarit në direktori',
        'recent_files_instruction': 'Klikoni dy herë për të hapur PDF-në drejtpërdrejt',
        'recent_no_directories': '(asnjë direktori e ruajtur)',
        'recent_no_files': '(asnjë skedar i ruajtur)',
        'recent_default_current': '⭐ Parazgjedhur: {0}',
        'recent_set_as_default': '⭐ Cakto si parazgjedhur',
        'recent_default_set_title': 'Direktoria parazgjedhur u caktua',
        'recent_default_set_message': 'Direktoria "{0}" u caktua si parazgjedhur për hapjen e PDF-ve.',
        'recent_default_set_voice': 'Direktoria parazgjedhur u caktua',
        'recent_directory_not_found': 'Direktoria nuk u gjet',
        'recent_file_not_found': 'Skedari nuk u gjet',
        'recent_remove_selected': 'Hiq',
        'recent_remove_title': 'Hiq rrugën',
        'recent_remove_confirm': 'A jeni i sigurt që dëshironi të hiqni rrugën "{0}" nga lista?',
        'recent_path_removed': 'Rruga u hoq',
        'recent_clear_all': 'Hiq të gjitha',
        'recent_clear_title': 'Hiq të gjitha rrugët',
        'recent_clear_confirm_type': 'A jeni i sigurt që dëshironi të fshini të gjitha {0}?',
        'recent_cleared': 'Lista u pastrua',
        'recent_path_not_found_title': 'Rruga nuk u gjet',
        'recent_path_not_found_message': 'Rruga "{0}" nuk ekziston më.',
        'recent_open_file': 'Hap skedar',
        'btn_open_recent': 'Hap',
        'recent_open_file_question': 'Dëshironi të hapni "{0}" si PDF?',
        'recent_not_pdf': 'Skedari i zgjedhur nuk është PDF.',
        'recent_more_entries': 'Më shumë hyrje...',
        'btn_remove': 'Hiq',
        'btn_clear': 'Pastro të gjitha',
        'recent_context_open': 'Hap',
        'recent_context_reveal': 'Shfaq në Finder',
        'recent_context_set_default': '⭐ Cakto si parazgjedhur',
        'recent_context_open_terminal': '💻 Hap terminalin',
        'recent_context_file_info': 'Informacion skedari',
        'recent_context_open_with_default': '📄 Hap me aplikacionin parazgjedhur',
        'recent_context_remove': 'Hiq nga lista',
        'recent_context_clear_all': 'Hiq të gjitha',
        'recent_file_info_title': 'Informacion skedari',
        'recent_file_info_name': 'Emri',
        'recent_file_info_path': 'Rruga',
        'recent_file_info_size': 'Madhësia',
        'recent_file_info_modified': 'Ndryshuar',
        'recent_file_info_pages': 'Faqet',
        'recent_error_reveal': 'Gabim gjatë hapjes në Finder',
        'recent_error_terminal': 'Gabim gjatë hapjes së terminalit',
        'recent_error_info': 'Gabim gjatë marrjes së informacionit të skedarit',
        'open_user_data_folder': 'Shfaq direktorinë e të dhënave të përdoruesit',

        # ============================================
        # 108. FSHIRJA E FAQEVE ÇIFT/TEK
        # ============================================
        "pages_delete_even": "Fshi të gjitha faqet çift",
        "pages_delete_odd":  "Fshi të gjitha faqet tek",
        "progress_even_pages": "Po fshihen faqet çift",
        "progress_odd_pages": "Po fshihen faqet tek",
        "progress_mark_delete_even": "{} faqe çift u shënuan për fshirje",
        "progress_mark_delete_odd":  "{} faqe tek u shënuan për fshirje",
