...
Tipp: A helyi menüben módosíthatja a beállításokat.
        ...
        # ============================================
        # 107. LEGUTÓBB HASZNÁLT ÚTVONALAK
        # ============================================

        'menu_recent': 'Legutóbbi',
        'menu_recent_dirs': 'Könyvtárak...',
        'menu_recent_files': 'Fájlok...',
        'recent_manage': 'Kezelés...',
        'recent_enable_tracking': 'Legutóbbi útvonalak mentése (adatvédelem)',
        'recent_enable_info': 'Kapcsolja ki ezt az opciót, hogy ne mentsen útvonalakat',
        'recent_tracking_disabled': 'Útvonalkövetés letiltva',
        'recent_enabled': 'engedélyezve',
        'recent_disabled': 'letiltva',
        'recent_tracking_status': 'Útvonalkövetés {0}',
        'recent_dialog_title': 'Legutóbbi útvonalak',
        'recent_tab_directories': 'Könyvtárak',
        'recent_tab_files': 'Fájlok',
        'recent_dirs_instruction': 'Dupla kattintás a fájlpárbeszéd megnyitásához a könyvtárban',
        'recent_files_instruction': 'Dupla kattintás a PDF közvetlen megnyitásához',
        'recent_no_directories': '(nincs mentett könyvtár)',
        'recent_no_files': '(nincs mentett fájl)',
        'recent_default_current': '⭐ Alapértelmezett: {0}',
        'recent_set_as_default': '⭐ Beállítás alapértelmezettként',
        'recent_default_set_title': 'Alapértelmezett könyvtár beállítva',
        'recent_default_set_message': 'A(z) "{0}" könyvtár lett beállítva alapértelmezettként a PDF-ek megnyitásához.',
        'recent_default_set_voice': 'Alapértelmezett könyvtár beállítva',
        'recent_directory_not_found': 'Könyvtár nem található',
        'recent_file_not_found': 'Fájl nem található',
        'recent_remove_selected': 'Eltávolítás',
        'recent_remove_title': 'Útvonal eltávolítása',
        'recent_remove_confirm': 'Biztosan el kívánja távolítani a(z) "{0}" útvonalat a listából?',
        'recent_path_removed': 'Útvonal eltávolítva',
        'recent_clear_all': 'Összes eltávolítása',
        'recent_clear_title': 'Összes útvonal eltávolítása',
        'recent_clear_confirm_type': 'Biztosan törölni szeretné az összes {0} elemet?',
        'recent_cleared': 'A lista törölve',
        'recent_path_not_found_title': 'Útvonal nem található',
        'recent_path_not_found_message': 'A(z) "{0}" útvonal már nem létezik.',
        'recent_open_file': 'Fájl megnyitása',
        'btn_open_recent': 'Megnyitás',
        'recent_open_file_question': 'Szeretné megnyitni a(z) "{0}" fájlt PDF-ként?',
        'recent_not_pdf': 'A kiválasztott fájl nem PDF.',
        'recent_more_entries': 'További bejegyzések...',
        'btn_remove': 'Eltávolítás',
        'btn_clear': 'Összes törlése',
        'recent_context_open': 'Megnyitás',
        'recent_context_reveal': 'Megjelenítés a Finderben',
        'recent_context_set_default': '⭐ Beállítás alapértelmezettként',
        'recent_context_open_terminal': '💻 Terminál megnyitása',
        'recent_context_file_info': 'Fájlinformáció',
        'recent_context_open_with_default': '📄 Megnyitás az alapértelmezett alkalmazással',
        'recent_context_remove': 'Eltávolítás a listából',
        'recent_context_clear_all': 'Összes eltávolítása',
        'recent_file_info_title': 'Fájlinformáció',
        'recent_file_info_name': 'Név',
        'recent_file_info_path': 'Útvonal',
        'recent_file_info_size': 'Méret',
        'recent_file_info_modified': 'Módosítva',
        'recent_file_info_pages': 'Oldalak',
        'recent_error_reveal': 'Hiba a Finderben való megnyitáskor',
        'recent_error_terminal': 'Hiba a terminál megnyitásakor',
        'recent_error_info': 'Hiba a fájlinformáció lekérésekor',
        'open_user_data_folder': 'Felhasználói adatkönyvtár megjelenítése',

        # ============================================
        # 108. PÁROS/PÁRATLAN OLDALAK TÖRLÉSE
        # ============================================
        "pages_delete_even": "Összes páros oldal törlése",
        "pages_delete_odd":  "Összes páratlan oldal törlése",
        "progress_even_pages": "Páros oldalak törlése",
        "progress_odd_pages": "Páratlan oldalak törlése",
        "progress_mark_delete_even": "{} páros oldal megjelölve törlésre",
        "progress_mark_delete_odd":  "{} páratlan oldal megjelölve törlésre",
