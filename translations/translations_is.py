...
Ábending: Í samhengisvalmyndinni geturðu stillt valkosti.
        ...
        # ============================================
        # 107. NÝLEGA NOTAÐAR SLÓÐIR
        # ============================================

        'menu_recent': 'Nýlega notað',
        'menu_recent_dirs': 'Möppur...',
        'menu_recent_files': 'Skrár...',
        'recent_manage': 'Stjórna...',
        'recent_enable_tracking': 'Vista nýlegar slóðir (persónuvernd)',
        'recent_enable_info': 'Slökktu á þessum valkosti til að vista ekki slóðir',
        'recent_tracking_disabled': 'Slóðarakning er óvirk',
        'recent_enabled': 'virkt',
        'recent_disabled': 'óvirkt',
        'recent_tracking_status': 'Slóðarakning {0}',
        'recent_dialog_title': 'Nýlegar slóðir',
        'recent_tab_directories': 'Möppur',
        'recent_tab_files': 'Skrár',
        'recent_dirs_instruction': 'Tvísmelltu til að opna skráarvalglugga í möppunni',
        'recent_files_instruction': 'Tvísmelltu til að opna PDF beint',
        'recent_no_directories': '(engar möppur vistaðar)',
        'recent_no_files': '(engar skrár vistaðar)',
        'recent_default_current': '⭐ Sjálfgefið: {0}',
        'recent_set_as_default': '⭐ Stilltu sem sjálfgefið',
        'recent_default_set_title': 'Sjálfgefin mappa stillt',
        'recent_default_set_message': 'Mappan "{0}" hefur verið stillt sem sjálfgefin til að opna PDF.',
        'recent_default_set_voice': 'Sjálfgefin mappa hefur verið stillt',
        'recent_directory_not_found': 'Mappa finnst ekki',
        'recent_file_not_found': 'Skrá finnst ekki',
        'recent_remove_selected': 'Fjarlægja',
        'recent_remove_title': 'Fjarlægja slóð',
        'recent_remove_confirm': 'Ertu viss um að þú viljir fjarlægja slóðina "{0}" af listanum?',
        'recent_path_removed': 'Slóð hefur verið fjarlægð',
        'recent_clear_all': 'Fjarlægja allt',
        'recent_clear_title': 'Fjarlægja allar slóðir',
        'recent_clear_confirm_type': 'Ertu viss um að þú viljir eyða öllum {0}?',
        'recent_cleared': 'Listi hefur verið hreinsaður',
        'recent_path_not_found_title': 'Slóð finnst ekki',
        'recent_path_not_found_message': 'Slóðin "{0}" er ekki lengur til.',
        'recent_open_file': 'Opna skrá',
        'btn_open_recent': 'Opna',
        'recent_open_file_question': 'Viltu opna "{0}" sem PDF?',
        'recent_not_pdf': 'Valin skrá er ekki PDF.',
        'recent_more_entries': 'Fleiri færslur...',
        'btn_remove': 'Fjarlægja',
        'btn_clear': 'Hreinsa allt',
        'recent_context_open': 'Opna',
        'recent_context_reveal': 'Sýna í Finder',
        'recent_context_set_default': '⭐ Stilltu sem sjálfgefið',
        'recent_context_open_terminal': '💻 Opna skipanalínu',
        'recent_context_file_info': 'Upplýsingar um skrá',
        'recent_context_open_with_default': '📄 Opna með sjálfgefnu forriti',
        'recent_context_remove': 'Fjarlægja af lista',
        'recent_context_clear_all': 'Fjarlægja allt',
        'recent_file_info_title': 'Upplýsingar um skrá',
        'recent_file_info_name': 'Nafn',
        'recent_file_info_path': 'Slóð',
        'recent_file_info_size': 'Stærð',
        'recent_file_info_modified': 'Breytt',
        'recent_file_info_pages': 'Síður',
        'recent_error_reveal': 'Villa við opnun í Finder',
        'recent_error_terminal': 'Villa við opnun skipanalínu',
        'recent_error_info': 'Villa við að sækja upplýsingar um skrá',
        'open_user_data_folder': 'Sýna notendagagnamöppu',

        # ============================================
        # 108. EYÐA JAFN/ÓJÖFN SÍÐUM
        # ============================================
        "pages_delete_even": "Eyða öllum jöfnum síðum",
        "pages_delete_odd":  "Eyða öllum ójöfnum síðum",
        "progress_even_pages": "Eyði jöfnum síðum",
        "progress_odd_pages": "Eyði ójöfnum síðum",
        "progress_mark_delete_even": "{} jafnar síður merktar til eyðingar",
        "progress_mark_delete_odd":  "{} ójafnar síður merktar til eyðingar",
