...
Dica: pode ajustar as configurações no menu de contexto.
        ...
        'menu_recent': 'Usados recentemente',
        'menu_recent_dirs': 'Diretórios...',
        'menu_recent_files': 'Ficheiros...',
        'recent_manage': 'Gerir...',
        'recent_enable_tracking': 'Guardar caminhos recentes (privacidade)',
        'recent_enable_info': 'Desative esta opção para não guardar caminhos',
        'recent_tracking_disabled': 'Rastreamento de caminhos desativado',
        'recent_enabled': 'ativado',
        'recent_disabled': 'desativado',
        'recent_tracking_status': 'Rastreamento de caminhos {0}',
        'recent_dialog_title': 'Caminhos recentes',
        'recent_tab_directories': 'Diretórios',
        'recent_tab_files': 'Ficheiros',
        'recent_dirs_instruction': 'Clique duas vezes para abrir o diálogo de ficheiro no diretório',
        'recent_files_instruction': 'Clique duas vezes para abrir o PDF diretamente',
        'recent_no_directories': '(nenhum diretório guardado)',
        'recent_no_files': '(nenhum ficheiro guardado)',
        'recent_default_current': '⭐ Predefinido: {0}',
        'recent_set_as_default': '⭐ Definir como predefinido',
        'recent_default_set_title': 'Diretório predefinido definido',
        'recent_default_set_message': 'O diretório "{0}" foi definido como predefinido para abrir PDFs.',
        'recent_default_set_voice': 'Diretório predefinido definido',
        'recent_directory_not_found': 'Diretório não encontrado',
        'recent_file_not_found': 'Ficheiro não encontrado',
        'recent_remove_selected': 'Remover',
        'recent_remove_title': 'Remover caminho',
        'recent_remove_confirm': 'Tem a certeza que pretende remover o caminho "{0}" da lista?',
        'recent_path_removed': 'Caminho removido',
        'recent_clear_all': 'Remover todos',
        'recent_clear_title': 'Remover todos os caminhos',
        'recent_clear_confirm_type': 'Tem a certeza que pretende eliminar todos os {0}?',
        'recent_cleared': 'Lista limpa',
        'recent_path_not_found_title': 'Caminho não encontrado',
        'recent_path_not_found_message': 'O caminho "{0}" já não existe.',
        'recent_open_file': 'Abrir ficheiro',
        'btn_open_recent': 'Abrir',
        'recent_open_file_question': 'Pretende abrir "{0}" como PDF?',
        'recent_not_pdf': 'O ficheiro selecionado não é um PDF.',
        'recent_more_entries': 'Mais entradas...',
        'btn_remove': 'Remover',
        'btn_clear': 'Limpar todos',
        'recent_context_open': 'Abrir',
        'recent_context_reveal': 'Mostrar no Finder',
        'recent_context_set_default': '⭐ Definir como predefinido',
        'recent_context_open_terminal': '💻 Abrir terminal',
        'recent_context_file_info': 'Informações do ficheiro',
        'recent_context_open_with_default': '📄 Abrir com a aplicação predefinida',
        'recent_context_remove': 'Remover da lista',
        'recent_context_clear_all': 'Remover todos',
        'recent_file_info_title': 'Informações do ficheiro',
        'recent_file_info_name': 'Nome',
        'recent_file_info_path': 'Caminho',
        'recent_file_info_size': 'Tamanho',
        'recent_file_info_modified': 'Modificado',
        'recent_file_info_pages': 'Páginas',
        'recent_error_reveal': 'Erro ao abrir no Finder',
        'recent_error_terminal': 'Erro ao abrir o terminal',
        'recent_error_info': 'Erro ao obter informações do ficheiro',
        'open_user_data_folder': 'Mostrar diretório de dados do utilizador',

        # ============================================
        # 108. GERADE UNGERADE SEITEN LÖSCHEN
        # ============================================
        "pages_delete_even": "Eliminar todas as páginas pares",
        "pages_delete_odd":  "Eliminar todas as páginas ímpares",
        "progress_even_pages": "A eliminar páginas pares",
        "progress_odd_pages": "A eliminar páginas ímpares",
        "progress_mark_delete_even": "{} página(s) par(es) marcada(s) para eliminar",
        "progress_mark_delete_odd":  "{} página(s) ímpar(es) marcada(s) para eliminar",
